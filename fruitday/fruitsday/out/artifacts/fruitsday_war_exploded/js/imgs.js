...
function addCart(idd,fidd)
{
	...
	if(add.value=="Add to cart")
	{
		...
		alert("The current product has been added to the shopping cart!");
}
...
function addStar(idd,fidd)
{
	...
	var f=document.getElementById("fform");
	if(add.value=="Follow the product"){
		f.action=contextPath+"/cartServlet?method=add&uid="+id+"&fid="+fid+"&str=star";
		f.submit();
	}
	else
		alert("The current product has been followed!");
}
