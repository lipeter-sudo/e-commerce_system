...
<div class="fruit_info">
  <div class="img_box">
    <%
      ...
      {
        out.println("<div id=\"p"+(i-1)+"\" name='imgList' class=\"" + cname + "\"><img src=\"img/fruits/" + fruit.getFid() + "/(" + i + ").jpg\" /></div>");
        cname="non";
      }
    %>
  ...
  <div class="fruit_text">
    ...
    <div class="fid">Item number:<%=fruit.getFid()%></div>
    <hr />

    <form  method="post" id="fform">
      <div class="fform">
        <div class="fform1">
      <div class="Uaddress">Deliver to :
    ...
    <%
      ...
      for(Fruit fruits:hotFruits)
      {
        out.print("    <div class=\"hot_fruit\">\n" +
                ...
                "        <div class=\"hf_mon\">in stock：￥<span>"+fruits.getUp()+"</span></div>\n" +
                "      </div>\n" +
                "    </div>");
        i++;
        if(i==4)
